...
"""
        ...
        try:
            ...
            chat_completion = self.groq_client.chat.completions.create(
                messages=[
                    {
                        "role": "system",
                        "content": "You are a professional email writing assistant. Write SHORT, warm, and friendly emails that feel natural and conversational - like a real person writing to another person. Keep it brief (3-5 sentences max). Use simple, natural language. Avoid corporate jargon, buzzwords, or overly formal language. Be genuine and human. Always include a natural greeting and sign-off. The mail has to be no reply. Add spaces wherever necessary."
                    },
                    {
                        "role": "user",
                        "content": prompt
            ...
            print(f"   Falling back to default email")
            return {
                'subject': 'Welcome to MIC Innovation Newsletter',
                'body': (
                    'Hello,\n\n'
    ...
    def create_message(self, to, subject, body, attachment_path=None, include_logo=True):
        ...
        Args:
            ...
            body: Email body
            attachment_path: Optional additional attachment
            include_logo: Whether to include MIC logo (default: True)
        """
    ...
    def compose_and_send(self, recipient_email, context, additional_instructions="", 
                        attachment_path=None, preview=False, include_logo=True):
        """
        ...
        Args:
            ...
            preview: If True, show preview and ask for confirmation
            include_logo: Whether to include MIC logo (default: True)
        """
        ...
        return self.send_email(recipient_email, email_content['subject'], 
                              email_content['body'], attachment_path, include_logo)
    ...
    def send_event_announcement(self, recipient_email, event_title, event_date=None, 
